...
<div class="wp-block-group alignwide"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-2-1024x683.png","isUserOverlayColor":true,"customGradient":"linear-gradient(0deg,rgb(23,23,23) 0%,rgba(255,255,255,0) 38%)","contentPosition":"bottom center","sizeSlug":"large","className":"is-style-default","style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-custom-content-position is-position-bottom-center is-style-default"><img class="wp-block-cover__image-background  size-large" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-2-1024x683.png" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(0deg,rgb(23,23,23) 0%,rgba(255,255,255,0) 38%)"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"level":3} -->
