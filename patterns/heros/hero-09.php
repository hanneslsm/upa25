 ...
 * Viewport width: 1920
 * Description: Hero encouraging visitors to subscribe to a newsletter.
 */
?>
...
<p class="has-text-align-center"><?php esc_html_e('Subscribe to our newsletter for the latest news and offers.', 'upa25'); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"center"} -->
