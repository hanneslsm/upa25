...
<!-- wp:details {"className":"is-style-chevron"} -->
<details class="wp-block-details is-style-chevron"><summary>Sed do eiusmod tempor?</summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block"} -->
<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'upa25');?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
...
<!-- wp:details {"className":"is-style-chevron"} -->
<details class="wp-block-details is-style-chevron"><summary>Incididunt ut labore et dolore?</summary><!-- wp:paragraph -->
<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'upa25');?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
...
<!-- wp:details {"className":"is-style-chevron"} -->
<details class="wp-block-details is-style-chevron"><summary>Quis nostrud exercitation?</summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block"} -->
<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'upa25');?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details --></div>
<!-- /wp:group --></div>
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholders/placeholder-3.webp" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
