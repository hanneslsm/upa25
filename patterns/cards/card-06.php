...
<div class="wp-block-column"><!-- wp:group {"className":"is-style-section-base","style":{"dimensions":{"minHeight":"100%"}},"layout":{"type":"default"}} -->
<div class="wp-block-group is-style-section-base" style="min-height:100%"><!-- wp:image {"aspectRatio":"3/2","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
