...
/**
 * Title: Content-04
 * Slug: upa25/content-04
 * Categories: upa25/content
 * Viewport width: 1920
 */
?>
<!-- wp:group {"metadata":{"name":"Section","categories":["upa25/content"],"patternName":"upa25/content-01"},"align":"full","layout":{"type":"constrained"}} -->
...
<!-- wp:columns {"verticalAlignment":null,"className":"on-medium-reverse-order","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|50"}}}} -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none","className":""} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholders/placeholder-1.webp" alt="" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
