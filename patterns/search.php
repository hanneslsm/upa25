...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e('Sorry, no results were found.', 'upa25');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Please check the spelling or try searching for something else.', 'upa25');?></p>
<!-- /wp:paragraph -->
